...
const TeamMember: React.FC<TeamMemberProps> = ({ name, role, image, index }) => {
  ...
  return (
    ...
    >
      <div className="aspect-[4/5] rounded-[2.5rem] overflow-hidden mb-6 bg-gray-200 shadow-sm">
        <img 
          alt={name} 
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="absolute top-0 right-0 p-12 pointer-events-none hidden lg:block">
            <span className="material-icons-outlined text-9xl text-black dark:text-white transition-colors duration-300">person_add</span>
          </div>
        </div>
      </div>
    </section>
