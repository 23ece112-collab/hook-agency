        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 mb-20">
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-8">
              <div className="w-8 h-8 bg-black dark:bg-white rounded-full flex items-center justify-center">
                <span className="material-icons-outlined text-white dark:text-black text-sm">phishing</span>
              </div>
            ...
            <div className="flex gap-4">
              {/* Instagram */}
              <a href="#" className="w-11 h-11 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all group" aria-label="Instagram">
              ...
              {/* X (Twitter) */}
              <a href="#" className="w-11 h-11 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all group" aria-label="X (formerly Twitter)">
              ...
              {/* LinkedIn */}
              <a href="#" className="w-11 h-11 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all group" aria-label="LinkedIn">
          ...
          <div>
            ...
            <ul className="space-y-4 font-medium dark:text-gray-300">
              <li><a className="hover:opacity-60 transition-opacity" href="#">Home</a></li>
              <li><a className="hover:opacity-60 transition-opacity" href="#">About</a></li>
              <li><a className="hover:opacity-60 transition-opacity" href="#">Case Studies</a></li>
              <li><a className="hover:opacity-60 transition-opacity" href="#">Blog</a></li>
            </ul>
          </div>
          <div>
